...
work_path = '/data/udsample'
dir_img = work_path + "/CamVid/imgs/"
dir_mask = work_path + "/CamVid/labels/"
...
experiment = wandb.init(project='synergic U-Net', resume='allow', anonymous='must')
experiment.config.update(
    dict(epochs=10, batch_size=8)
)
...
def train_model(
    ...
    print(".................................", best_score, ".....................................")
    df['synergy'] = lis
    experiment.watch(model, log='all')
    return best_score
...
if __name__ == '__main__':
    for i in range(0, 1):
        ...
        name = file_path + "/synergy_without_normalize.csv"
